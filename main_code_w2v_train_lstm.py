...
#读取数据
base_dir = '/content/drive/My Drive/nlp/data'
train_dir = os.path.join(base_dir, 'cnews.train.txt')
test_dir = os.path.join(base_dir, 'cnews.test.txt')
val_dir = os.path.join(base_dir, 'cnews.val.txt')
vocab_dir = os.path.join(base_dir, 'cnews.vocab.txt')

save_dir = '/content/drive/My Drive/nlp/checkpoints/lstm_cnn'
...
def plot_acc_loss(history):
    ...
    plt.tight_layout()
    plt.savefig('w2v_t_acc_loss_8.png')
    plt.show()
...
model.save(os.path.join(save_dir,'w2v_train_model_tem_8.h5'))
